  ...
  return (
    <label className="font-app flex cursor-pointer select-none items-center gap-[0.65rem] text-[0.83rem] text-app-2">
      <div
        ...
        className={`relative h-5.25 w-9.5 shrink-0 cursor-pointer rounded-[21px] border-[1.5px] transition-colors duration-200 ${checked ? "border-(--accent) bg-(--accent)" : "border-app-2 bg-app-4"}`}
      >
        <div
